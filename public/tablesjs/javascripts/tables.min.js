...
var tablesJs = {
	...
	draw: function(parent, h) {
        ...
        if (h['on_edit_cell'] != null) {
            filtersJs.events[parent.id+".on_edit_cell"] = h['on_edit_cell'];
        }

        // store function to trigger when the user removes a value
        if (h['on_remove_row'] != null) {
            filtersJs.events[parent.id+".on_remove_row"] = h['on_remove_row'];
        }
	...
	remove: function(parent, rownum) {
		...
		// call event
        if (filtersJs.events[parent.id+".on_remove_row"]) {
            // call the function
            filtersJs.events[parent.id+".on_remove_row"](rownum);
        }
	},
